...
export default defineConfig({
  ...
  branding: {
    ...
    favicon: "/logo.svg",
    description: "বাংলায় AI প্রম্পট শেয়ার করুন এবং আবিষ্কার করুন",
  ...
  auth: {
    ...
    // Enable email/password sign-in when OAuth credentials are not configured.
    allowRegistration: true,
  },

  // Internationalization
  i18n: {
    locales: ["bn", "en", "tr", "es", "zh", "ja", "ar", "pt", "fr", "it", "de", "nl", "ko", "ru", "he", "el", "az", "fa"],
    defaultLocale: "bn",
  },
